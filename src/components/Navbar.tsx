...
export const Navbar = () => {
  ...
  return <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Popover>
              ...
              <PopoverContent className="w-48 p-2" align="end">
                {isSignedIn ? <div className="space-y-1">
                    <button onClick={() => navigate('/profile')} className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors">
                      <User className="w-4 h-4" />
                      My Profile
                    </button>
                    <button onClick={() => navigate('/wishlist/my-orders')} className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors">
                      <ClipboardList className="w-4 h-4" />
                      My Orders
                    </button>
                  </div> : <div className="space-y-1">
                    <Link to="/auth" className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors">
                      Sign In
                    </Link>
                    <button onClick={() => navigate('/signup')} className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted rounded-md transition-colors">
            ...
            <button className="p-2 hover:bg-muted rounded-full" onClick={() => navigate('/wishlist')}>
            ...
            <Link to="/dashboard" className="p-2 hover:bg-muted rounded-full flex items-center gap-2 text-sm">
      ...
      {isOpen && <div className="md:hidden bg-white border-t border-border animate-fade-in">
